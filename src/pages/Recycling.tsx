          ...
          <div className="space-y-8">
            ...
            <h1 className="text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-white">
                Free Electronics Recycling Charlotte
              </span>
            </h1>
            
            <p className="text-xl text-gray-200 max-w-2xl mx-auto font-light">
              Responsibly recycle your old computers, phones, and electronics at KorTech Service. 
              Free, secure, and environmentally friendly disposal in Charlotte, NC.
            </p>
